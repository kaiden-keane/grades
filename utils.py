...
def load_semesters(data_directory):
    semesters = []
    try:
    ...
    for file in files:
        ...
        new_sem.courses = _load_semester(join(data_directory, file))
        semesters.append(new_sem)
    
    return semesters


def _load_semester(filename):
    courses = []
...
def save_semesters(data_directory, semesters):
    for semester in semesters:
        _save_semester(data_directory + "/" + semester.name + ".txt", semester.courses)


def _save_semester(filename, courses):
    try:
